...
<h1 style="color: red;margin-left: 30%;">NEW</h1>
		...
		<div id="postsclass3">
            ...
            <?php
		include('db.php');
		$sql="SELECT * FROM audiosdkut ORDER BY ID DESC";
		...
		if($queryResults >0) {
			while($row = mysqli_fetch_assoc($result)) {
				...
				echo "
				<div style='height:auto;margin-top:10%;width:100%;margin-left:5%;background-color: grey;'>
...
if (isset($_POST['upload'])) {
	if(!empty($_FILES['file']['name'])){
		...
		$sql = "INSERT INTO audiosdkut(name, caption) VALUES ('$name','$caption')";
